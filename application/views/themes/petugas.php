        ...
        <div class="container">
          ...
          <div style="height: 0px;" class="nav-collapse collapse">
            <ul class="nav">
			  ...
			  <li><a href="<?php echo site_url('petugas/homePetugas'); ?>">Data Depot</a></li>
			  <li><a href="<?php echo site_url('petugas/isiUlang'); ?>">Isi Ulang Depot</a></li>
              <li><a href="<?php echo site_url('petugas/laporan'); ?>">Laporan</a></li>
              <li><a href="<?php echo site_url('petugas/dataMember'); ?>">Data Member</a></li>
              <li><a href="<?php echo site_url('petugas/logout'); ?>">Logout</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
